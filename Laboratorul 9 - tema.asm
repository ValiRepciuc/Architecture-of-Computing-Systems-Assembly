; Realizaţi un program care afişează un desen pe ecran
...
.code
    ...
    int 10h
    anim: mov al,3
          call patrat         ;il desenez cu alb (3)
          call delay
          mov al,0
          call patrat         ;il "sterg" (il redesenez cu negru = 0)
          inc x
          dec n
          jnz anim
    mov ah,01h
